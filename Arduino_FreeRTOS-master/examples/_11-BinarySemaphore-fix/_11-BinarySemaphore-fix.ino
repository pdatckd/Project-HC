...
{  
    ...
    if(binSemaphore_A != NULL)
    {
        ...
        xTaskCreate(LPT_Task, "LPT_Task", 256, NULL, 1, &LPT_TaskHandle);
    }
    else
    {
...
void LPT_Task(void* pvParameters)
{
    ...
    xTaskCreate(HPT_Task, "HPT_Task", 256, NULL, 3, &HPT_TaskHandle); 


    printMsg(LPT_TaskHandle,"LPT_Task Creating MPT");  
    xTaskCreate(MPT_Task, "MPT_Task", 256, NULL, 2, &MPT_TaskHandle); 
